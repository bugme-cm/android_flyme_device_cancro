...
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService CMSettingsProvider NfcNci \
                     QuickBoot CMSettings
vendor_saved_apps := Bluetooth NfcNci
...
#-----------------------------------------------------------------------------
board_remove_apps := LogReport Search 
...
override_property += \
    ro.flyme.romer=moonlight \
    ro.product.model_romer=cancro_moonlight
